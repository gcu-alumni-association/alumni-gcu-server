...
const { register, reset_password, getUser, updateProfile, getVerifiedUsers, forgotPassword, checkEmail, getUserById, recommendUsers, upload, uploadProfilePhoto, removeProfilePhoto, getProfilePhotoById } = require("../controllers/user-controller");
...
// Route for deleting the profile photo
router.delete('/remove-profile-photo', verifyToken, removeProfilePhoto);
